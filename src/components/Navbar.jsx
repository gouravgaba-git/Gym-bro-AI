  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-[#070a14]/85 border-b border-white/10 shadow-2xl transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-[#ff416c] to-[#ff4b2b] p-0.5 shadow-lg shadow-[#ff4b2b]/30 group-hover:scale-105 transition-transform duration-300">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <span className="font-black text-lg sm:text-xl tracking-wider bg-gradient-to-r from-white via-gray-100 to-gray-400 bg-clip-text text-transparent uppercase">
                THE GYM BRO
              </span>
              <span className="px-2 py-0.5 rounded-full text-[9px] font-black tracking-widest bg-[#ff4b2b]/20 text-[#ff4b2b] border border-[#ff4b2b]/30 uppercase">
                PRO AI
              </span>
            </div>
        ...
        {/* Right Actions: Auth Button / User Dropdown */}
        <div className="flex items-center gap-3" ref={dropdownRef}>
          {!isAuthenticated ? (
            <button
              className="px-5 py-2.5 rounded-2xl bg-gradient-to-r from-[#ff416c] to-[#ff4b2b] hover:from-[#ff4b2b] hover:to-[#ff416c] text-white text-xs font-extrabold tracking-wide flex items-center gap-2.5 shadow-lg shadow-[#ff4b2b]/30 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer"
            ...
            <div className="relative">
              <button
                className="flex items-center gap-3 bg-[#0d1322] hover:bg-[#161f33] border border-white/10 p-1.5 pr-4 rounded-full cursor-pointer transition-all duration-300 shadow-md group"
              ...
              >
                <div className="relative">
                  <img
                    ...
                    className="w-8 h-8 rounded-full object-cover ring-2 ring-[#ff4b2b]/50 group-hover:ring-[#ff4b2b] transition-all"
                    onError={(e) => {
          ...
          <button
            className="md:hidden w-10 h-10 rounded-2xl bg-[#0d1322] border border-white/10 text-gray-300 hover:text-white flex items-center justify-center transition-all cursor-pointer"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-white/10 bg-[#070a14] px-4 py-4 space-y-2 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <button
            ...
            className="w-full text-left px-4 py-3 rounded-2xl text-xs font-extrabold flex items-center gap-3 text-gray-300 bg-white/5 hover:bg-white/10 cursor-pointer"
          >
            <span>👤</span>
            <span>My Profile</span>
          </button>
