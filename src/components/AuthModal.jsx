...
const AuthModal = ({ onClose, reason }) => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      ...
      console.error("Web GIS Sign-in error:", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleNativeSignInClick = async () => {
    try {
      setLoading(true);
  ...
  return (
    <div className="auth-card-container">
      <div className="auth-card">
        ...
        {/* Single Action Section - GIS Button for Web, Native Button for Android */}
        <div className="auth-action-section">
          {isClientIdConfigured ? (
            isNative ? (
              ...
              <div className="google-gis-btn-container">
                <GoogleLogin
            ...
            <button className="auth-btn-custom disabled" disabled>
