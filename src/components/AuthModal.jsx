...
const AuthModal = ({ onClose, reason }) => {
  ...
  const displayReason = reason || authModalReason || "Sign in with Google to generate personalized AI workout splits, sync progress, and track athletic streak.";
  ...
  return (
    <div className="auth-card-container">
      <div className="auth-card card" style={{ position: "relative" }}>
        {onClose && (
          <button
            onClick={handleClose}
